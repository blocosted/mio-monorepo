...
const MOOD_PROMPTS: Record<MusicMood, MoodPromptMapping> = {
    calm: {
        ...
        variations: [
            'peaceful ambient music with soft piano notes, gentle and calming',
            'tranquil instrumental background music, floating strings and piano',
        ],
    ...
    mysterious: {
        ...
        variations: [
            'enigmatic background music, soft mysterious tones, fantasy atmosphere',
            'magical ambient music, soft mysterious melody with ethereal sounds',
        ],
        recommendedDuration: 20,
    },
    adventurous: {
        ...
        variations: [
            'heroic adventure theme, inspiring orchestral music, epic and uplifting',
            'grand adventure music, sweeping strings, courageous melody',
        ],
    ...
    tense: {
        ...
        variations: [
            'tense background music, suspenseful pads, building anxiety, dramatic',
            'dark suspenseful music, ominous tones, tension building',
        ],
    ...
    joyful: {
        ...
        variations: [
            'cheerful background music, light and happy, uplifting melody',
            'joyful instrumental music, bright and positive, playful tune',
        ],
        recommendedDuration: 20,
    },
    sad: {
        ...
        variations: [
            'sorrowful piano music, emotional and sad, gentle melancholy',
            'melancholic ambient music, touching and emotional, soft sadness',
        ],
        recommendedDuration: 18,
    },
    magical: {
        ...
        variations: [
            'enchanting fairy music, magical sparkles, dreamy and wonderful',
            'whimsical fantasy music, magical atmosphere, fairy tale wonder',
        ],
        recommendedDuration: 20,
    },
    serene: {
        ...
        variations: [
            'peaceful meditation music, serene and tranquil, gentle flowing',
            'zen ambient music, calm and peaceful, soft nature atmosphere',
        ],
        recommendedDuration: 20,
    },
};
