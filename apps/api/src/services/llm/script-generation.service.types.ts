...
export interface IScriptGenerationService {
   ...
   */
  buildConstraints(targetMinutes: number, providerType?: 'openai' | 'anthropic'): ScriptGenerationConstraints;
   ...
   */
  generateScript(input: ScriptGenerationInput, provider: ILLMRepository): Promise<ScriptGenerationResult>;
}
