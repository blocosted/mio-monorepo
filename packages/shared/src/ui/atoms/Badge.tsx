  ...
  'inline-flex items-center rounded-md border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        outline: 'text-gray-900 border-gray-400 bg-gray-100',
        ...
        under: 'border-transparent bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300',
        over: 'border-transparent bg-pink-100 text-pink-700 dark:bg-pink-900/50 dark:text-pink-300',
