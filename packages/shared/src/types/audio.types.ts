 ...
 */
export const VoiceUseCaseValues = ['narrative_story', 'conversational', 'characters', 'advertisement', 'informative'] as const;
 ...
 */
export const SfxLibraryCategoryValues = ['ambient', 'effects', 'transitions', 'foley', 'creatures'] as const;
 ...
 */
export const SfxEnvironmentValues = ['indoor', 'outdoor', 'fantasy', 'urban', 'nature'] as const;
 ...
 */
export const WeatherConditionValues = ['clear', 'rainy', 'stormy', 'snowy', 'foggy', 'any'] as const;
 ...
 */
export const AudioMoodValues = ['peaceful', 'mysterious', 'tense', 'magical', 'adventurous'] as const;
 ...
 */
export const MusicMoodValues = ['calm', 'mysterious', 'adventurous', 'tense', 'joyful', 'sad', 'magical', 'serene'] as const;
